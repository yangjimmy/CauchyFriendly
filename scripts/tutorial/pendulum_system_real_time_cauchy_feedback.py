...
# Kalman step
def Kalman_step(x_kf, P_kf, z, u, taylor_order = 2):
    """
    ...
    x_kf = nonlin_transition_model(x_kf,u)
...
while True:
    if time.time() - start_time >= timer - dt*.01:
        ...
        if estimator_start:
            ...
            # x_kf, P_kf = Kalman_step(x_kf,P_kf, z,u)
            # Run Cauchy filter step
            xhat, Phat, wavg_xhat, wavg_Phat = cauchyEst.step(z, u)
            ...
            # Store returned sqtates, measurement
